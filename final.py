...
if page == "홈":
    st.image(r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\따릉이소개.jpeg", 
             caption="서울자전거 개요", use_column_width=True)
    st.image(r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\따릉이 실제 사진.jpeg", 
             caption="서울 시내 따릉이 대여소 모습", use_column_width=True)
    st.image(r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\공공자전거.jpg", 
             caption="따릉이 일러스트", use_column_width=True)
...
if page == "따릉이 데이터":
    ...
    st.image(r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\성별 따릉이 이용건수.png", caption="성별 이용건수 분석", use_column_width=True)
    
    # 연령대별 이용건수 분석
    st.subheader("2. 연령대별 따릉이 이용건수")
    st.image(r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\연령대별 따릉이 이용건수.png", caption="연령대별 이용건수 분석", use_column_width=True)
    
    # 시간대별 이용건수 분석
    st.subheader("3. 시간대별 따릉이 이용건수")
    st.image(r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\시간대별 따릉이 이용건수.png", caption="시간대별 이용건수 분석", use_column_width=True)
    
    # 요일별 이용건수 분석
    st.subheader("4. 요일별 따릉이 이용건수")
    st.image(r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\요일별 따릉이 이용건수.png", caption="요일별 이용건수 분석", use_column_width=True)
...
if page == "지도 데이터":
    ...
    # 로컬 파일 경로 설정
    population_data_path = r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\서울시 인구밀도.xlsx"
    bike_data_path = r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\공공자전거 대여소 정보(24.6월 기준).xlsx"
    geojson_path = r"C:\Users\user\Desktop\서울대 대학원\기초 프로그래밍(1학년 1학기)\2차 과제\데이터들\서울특별시 지역구.geojson"
